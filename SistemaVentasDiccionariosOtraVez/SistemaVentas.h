	...
	public:
     ...
     private:	   
	   /* INCLUYE AQUI LAS DEFINICIONES RELATIVAS A LA REPRESENTACION */
		DiccionarioHash <tProducto, int> dicOfertas;
		DiccionarioHash<tProducto, Lista<tCliente>> dicClientes;
		DiccionarioHash<tCliente, DiccionarioHash<tProducto, Lista<tCliente>::Iterator>> dicIt;
		DiccionarioHash<tProducto, Lista<Venta>::Iterator> dicVentas;
