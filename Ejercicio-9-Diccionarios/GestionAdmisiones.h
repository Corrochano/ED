...
class iPaciente {
public:
    iPaciente(Paciente p, int g, Lista<CodigoPaciente>::Iterator it);
    Paciente getPaciente() const;
    int getGravedad() const;
    Lista<CodigoPaciente>::Iterator getIt() const;

private:
    Paciente _p;
    int _g;
    Lista<CodigoPaciente>::Iterator _it;
};
...
private:
  ...
  // eficientemente este TAD
    DiccionarioHash<CodigoPaciente, iPaciente> dicPacientes;
    DiccionarioHash<int, Lista<CodigoPaciente>> dicGravedad;
};
